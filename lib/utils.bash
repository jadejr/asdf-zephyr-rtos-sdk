...
# NOTE: You might want to remove this if zephyr-rtos-sdk is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if zephyr-rtos-sdk has other means of determining installable versions.
	list_github_tags
}
